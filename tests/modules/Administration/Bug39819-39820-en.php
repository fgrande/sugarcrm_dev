...
class Bugs39819_39820_en extends Sugar_PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        file_put_contents($this->customDir . "/en_us.help.DetailView.html", "<h1>ENBugs39819-39820</h1>");
    }


    public function tearDown()
    {
        unlink($this->customDir . "/en_us.help.DetailView.html");
    }

    public function testLoadCustomEnHelp()
    {
